...
tools: Bash, Read, Write, mcp__boundary-lab__generate, mcp__boundary-lab__solve, mcp__boundary-lab__get_job
---
...
- Poll with `sleep 30` (Bash) between `get_job` calls. As a subagent you get NO
...
- Your final message is the ≤10-line report from step (e) — scalars, job ids, and URLs
  only; never arrays.
